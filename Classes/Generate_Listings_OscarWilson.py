...
class Ebay:
    ...
    def __init__(self):
        self.mfr_code = 'MTD'
        self.mfr_name = 'MTD'
        self.product_ids_filepath = r'T:/ebay/' + self.mfr_code + '/Data/2018/New Listings/ProductIds.csv'
        self.save_to_filepath = r'T:/ebay/' + self.mfr_code + '/Data/2018/New Listings/Generated_Listings' \
    ...
    def set_partstree_info(self, products):
        ...
        for product in products:
            parts_tree_part = parts_tree_scraper.get_scrape_single(product['Product ID'].strip("[]"), self.mfr_name)
